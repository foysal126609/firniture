                        ...
                        <tr>
                            ...
                            <td>
                                @if($category->status==1)
                                    <a href="{{ route('status',['id'=>$category->id]) }}" class="btn btn-primary px-5">Unpublished</a>
                               @else
                                    <a href="{{ route('status',['id'=>$category->id]) }}" class="btn btn-primary px-5">Published</a>
                                @endif
                                    <a href="{{ route('delete',['id'=>$category->id]) }}" class="btn btn-primary px-5" onclick=" return confirm('Are you Sure DELETE this !!')">Delete</a>
                                    <a href="{{ route('edit',['id'=>$category->id]) }}" class="btn btn-primary px-5">edit</a>
                            </td>
                        </tr>
                            <?php $i++?>
                        @endforeach
